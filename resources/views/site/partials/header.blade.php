        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-sm-6">
                    <form action="{{route('search.action')}}" class="search-wrap">
                            ...
                            <ul class="navbar-nav ml-auto">
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="{{ route('account.profile',auth::id()) }}"> <i class="fa fa-user"></i> &emsp; My Profile</a>
                                        <a class="dropdown-item" href="{{ route('account.orders') }}"><i class="fa fa-list"></i> &emsp;My Orders</a>
                                        <a class="dropdown-item" href="{{ route('logout') }}"
                                           onclick="event.preventDefault();
                                                                                                                                     document.getElementById('logout-form').submit();">
                                            <i class="fa fa-power-off"></i> &emsp;{{ __('Logout') }}
                                            </a>
