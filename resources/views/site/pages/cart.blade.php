            ...
            <div class="row">
                <div class="col-sm-12">
                    @if (Session::has('message'))
                        <p class="alert alert-success">{{ Session::get('message') }}<button type="button" class="close" data-dismiss="alert">×</button></p>
                    @endif
                </div>
            </div>
            <div class="row">
                ...
                <aside class="col-sm-3">
                    ...
                    <p class="alert alert-success">Add KES 500.00 of eligible items to your order to qualify for FREE
                        Shipping. </p>
...
{{--                    </figure>--}}
                    ...
                    <figure class="itemside mb-3">
                        <aside class="aside"> <img src="{{ asset('../../../../frontend/images/icons/mpesa.png') }}">
                        </aside>
                        <div class="text-wrap small text-muted">
                            Pay By Mpesa Online
                        </div>
                    ...
                    <a href="{{ route('checkout.index') }}" >
                        <figure class="itemside mb-3">
                            <aside class="aside"> <img src="{{ asset('../../../../frontend/images/icons/paypal-logo.png') }}">
                            </aside>
                            <div class="text-wrap small text-muted">
                                Pay using Paypal
                            </div>
