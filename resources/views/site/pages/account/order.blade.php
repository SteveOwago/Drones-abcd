...
@section('content')
    <div class="app-title">
        <div>
            <h2><i class="fa fa-bar-chart"></i> {{ $pageTitle }}</h2>
        </div>
    </div>
    <hr>
    <div class="row">
        <div class="col-md-10 offset-1">
            <div class="tile">
                <section class="invoice">
                    <div class="row mb-4">
                        <div class="col-6">
                            <h3 class="page-header"><i class="fa fa-globe"></i> {{ $order->order_number }}</h3>
                        </div>
                        <div class="col-6">
                    ...
                    <div class="row invoice-info">
                        ...
                        <div class="col-4">Ship To
                            <address><strong>{{ $order->first_name }}
                                ...
                                {{ $order->country }} {{ $order->post_code }}<br>{{ $order->phone_number }}<br>
                            </address>
                        </div>
                        <div class="col-4">
